...
export const INITIAL_COMPANIES: Company[] = [
  { id: 'comp-1', name: 'TeS Manutenção Industrial S/A', cnpj: '12.345.678/0001-90', status: 'Ativo' },
...
export const INITIAL_EMPLOYEES: Employee[] = [
  {
    ...
    phone: '(47) 98844-1122',
    email: 'joao.silva@tesmanutencao.com.br',
    company: 'TeS Manutenção Industrial S/A',
  ...
  },
  {
    ...
    phone: '(47) 99122-3344',
    email: 'marcos.nogueira@tesmanutencao.com.br',
    company: 'TeS Manutenção Industrial S/A',
    unit: 'Planta Principal - Joinville',
  ...
  },
  {
    ...
    phone: '(47) 98455-6677',
    email: 'juliana.lima@tesmanutencao.com.br',
    company: 'TeS Manutenção Industrial S/A',
    unit: 'Planta Principal - Joinville',
    department: 'Montagem Eletromecânica',
    area: 'Linha CNC 01',
  ...
  },
  {
    ...
    phone: '(47) 99788-9900',
    email: 'rodrigo.alencar@tesmanutencao.com.br',
    company: 'TeS Manutenção Industrial S/A',
    unit: 'Planta Principal - Joinville',
  ...
  },
  {
    ...
    phone: '(47) 98111-2233',
    email: 'paulo.siqueira@tesmanutencao.com.br',
    company: 'TeS Manutenção Industrial S/A',
    unit: 'Planta Principal - Joinville',
...
export const INITIAL_USERS: User[] = [
  {
    ...
    email: 'admin@tesmanutencao.com.br',
    phone: '(47) 98800-0001',
    role: 'Administrador',
    company: 'TeS Manutenção Industrial S/A',
    unit: 'Planta Principal - Joinville',
  ...
  },
  {
    ...
    email: 'gerente@tesmanutencao.com.br',
    phone: '(47) 98800-0002',
    role: 'Gerente',
    company: 'TeS Manutenção Industrial S/A',
    unit: 'Planta Principal - Joinville',
  ...
  },
  {
    ...
    email: 'pcm@tesmanutencao.com.br',
    phone: '(47) 98800-0004',
    role: 'Planejamento',
    company: 'TeS Manutenção Industrial S/A',
    unit: 'Planta Principal - Joinville',
...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  ...
  },
  {
    ...
    table: 'users',
    recordId: 'user-admin',
    recordIdentifier: 'admin@tesmanutencao.com.br',
